...
import type { I18nReplacements, Lang } from './types';
...
export const I18N: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    large_request_input:"Входной контекст: ~{amount} кр.",
    large_request_output:"Генерация ответа (до {tokens} токенов): ~{amount} кр.",
    large_request_total:"Итого (оценка): ~{amount} кр.",
    large_request_balance:"Ваш баланс: {amount} кр.",
    large_request_insufficient:"Недостаточно средств для этого запроса"
  },
  en: {
    ...
    large_request_desc:"This request exceeds 100,000 characters. Estimated cost in credits is shown below.",
    ...
    large_request_input:"Input context: ~{amount} cr.",
    large_request_output:"Response generation (up to {tokens} tokens): ~{amount} cr.",
    large_request_total:"Estimated total: ~{amount} cr.",
    large_request_balance:"Your balance: {amount} cr.",
    large_request_insufficient:"Insufficient funds for this request"
  }
};

export function t(key: string, replacements?: I18nReplacements): string {
