...
export async function runExpertRerankEval() {
  ...
  const metadataOnly = new TieredRetriever(
  ...
  return {
    ...
    passed: queries.length >= 18 && rerankRecall >= metadataRecall,
  };
}
