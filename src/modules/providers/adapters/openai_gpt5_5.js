 ...
 * Focus: Reasoning-first, tool-heavy, RAG (file_search).
...
class OpenAIGPT55Provider extends BaseProvider {
  ...
  async *handleChat(messages, config, options = {}) {
    ...
    // Enforce constraints (no temperature, top_p, or user for GPT-5.5)
    const forbidden = [
    ...
    ProviderUtils.cleanUnsupportedParams(params, forbidden);
...
module.exports = new OpenAIGPT55Provider();
module.exports.OpenAIGPT55Provider = OpenAIGPT55Provider;
